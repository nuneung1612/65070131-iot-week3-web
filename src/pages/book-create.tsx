...
export default function BookCreatePage() {
  ...
  const bookCreateForm = useForm({
    ...
    validate: {
      ...
      des: isNotEmpty("กรุณาระบุรายละเอียดหนังสือ"),
      preview: isNotEmpty("กรุณาระบุเรื่องย่อหนังสือ"),
        ...
        <Container className="mt-8">
          ...
          <form onSubmit={bookCreateForm.onSubmit(handleSubmit)} className="space-y-8">
            ...
            <TextInput
                  ...
                  {...bookCreateForm.getInputProps("des")}
                />
                {/* TODO: เพิ่มเรื่องย่อ */}
                <TextInput
                  label="เรื่องย่อ"
                  placeholder="เรื่องย่อ"
                  {...bookCreateForm.getInputProps("preview")}
                />
